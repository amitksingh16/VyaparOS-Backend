...
const { getCADashboard, addClient, completeSetup, getClientDetails, updateClient, getRecentActivities, triggerReminders, getEscalations, bulkAssignClients, bulkMarkFiledClients } = require('../controllers/caController');
...
// Bulk mark clients as filed
router.put('/clients/bulk-mark-filed', protect, bulkMarkFiledClients);
